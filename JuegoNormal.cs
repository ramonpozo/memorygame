...
namespace Memory
{
    public partial class JuegoNormal : Form
    {
        ...
        string[] palabras = { "Cat", "Dog", "Mouse", "Horse", "Frog", "Elephant", "Bird", "Tiger" };

        public JuegoNormal(string name)
        {
            InitializeComponent();
            ...
            casillas[12] = pictureBox13;
            casillas[13] = pictureBox14;
            casillas[14] = pictureBox15;
            casillas[15] = pictureBox16;
            ...
            if (!aciertos.Contains(pos))
            {
                if (casillas[pos].ImageLocation != @"../../Cartas/PD.png")
                {
                    ...
                    else if (pos != pos1)
                    {
                        ...
                        if (posiciones[pos1] > 8)
                        {
                            pareja1 = posiciones[pos1] - 8;
                        }
                        else
                        {
                        ...
                        if (posiciones[pos2] > 8)
                        {
                            pareja2 = posiciones[pos2] - 8;
                        }
                        else
                        {
        ...
        public void ganar()
        {
            ...
            Ranking juego = new Ranking(name, tiempo, pistas, 2);
            juego.ShowDialog();
        ...
        private void pictureBox1_Click(object sender, EventArgs e)
        {
            ...
            if (posiciones[casilla] <= 8)
            {
                casillas[casilla].ImageLocation = @"../../Cartas/Animales/" + posiciones[casilla] + ".png";
            }
            else
            {
                System.Console.WriteLine("Posiciones en la casilla " + casilla + " = " + posiciones[casilla]);
                writeOnImage(casillas[casilla], palabras[posiciones[casilla] - 9]);
            }
        ...
        private void pictureBoxPista_Click(object sender, EventArgs e)
        {
            if (!primerClick && pistas > 0)
            {
                ...
                if (posiciones[pos1] > 8)
                {
                    cartaSeleccionada = posiciones[pos1] - 8;
                }
                else
                {
                ...
                for (int i = 0; i < posiciones.Length; i++)
                {
                    ...
                    if (busqueda == cartaSeleccionada && i != pos1)
                    {
                        if (posiciones[i] <= 8)
                        {
                            casillas[i].ImageLocation = @"../../Cartas/Animales/" + posiciones[i] + ".png";
                        }
                        else
                        {
