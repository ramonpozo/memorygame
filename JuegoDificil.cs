...
namespace Memory
{
    public partial class JuegoDificil : Form
    {
        ...
        string[] palabras = { "One", "Two", "Three", "Four", "Five", "Six", "Seven", "Eight", "Nine", "Zero" };

        public JuegoDificil(string name)
        {
            InitializeComponent();
            ...
            casillas[16] = pictureBox17;
            casillas[17] = pictureBox18;
            casillas[18] = pictureBox19;
            casillas[19] = pictureBox20;
        ...
        public void ganar()
        {
            ...
            Ranking juego = new Ranking(name, tiempo, pistas, 3);
            juego.ShowDialog();
        ...
        private void pictureBox1_Click(object sender, EventArgs e)
        {
            ...
            {
                casillas[casilla].ImageLocation = @"../../Cartas/Numeros/" + posiciones[casilla] + ".png";
            }
            else
            {
            ...
            if (!primerClick && pistas > 0)
            {
                ...
                for (int i = 0; i < posiciones.Length; i++)
                {
                    ...
                    if (busqueda == cartaSeleccionada && i != pos1)
                    {
                        if (posiciones[i] <= numCartas / 2)
                        {
                            casillas[i].ImageLocation = @"../../Cartas/Numeros/" + posiciones[i] + ".png";
                        }
                        else
                        {
